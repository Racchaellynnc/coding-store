    ...
    <div className='about-container'>
        ...
        <Helmet>
            ...
            <div className="intro-container">
                {/* <img src="https://i.postimg.cc/Y0j2zbYz/Untitled-5.png" alt="computer" /> */}
            </div>
            ...
            <div className="about-text">
                ...
                <section className="about-section">
                    <div className="title about-title">About Us</div>
                        <div className="about-us">
                            We are a family of 5 with the last name of Coder. All of us love to write code ( even our 1 year old baby writes giberish code). 
